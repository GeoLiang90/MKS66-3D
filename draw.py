...
def add_sphere( points, cx, cy, cz, r, step ):
    collection = generate_sphere(points,cx,cy,cz,r,step)
    x = 0
    while x != len(collection):
        add_edge(points,collection[x][0],collection[x][1],collection[x][2],
        collection[x][0] + 1,collection[x][1] + 1,collection[x][2] + 1)
        x += 1
...
def add_torus( points, cx, cy, cz, r0, r1, step ):
    collection = generate_torus(points,cx,cy,cz,r0,r1,step)
    x = 0
    while x != len(collection):
        add_edge(points,collection[x][0],collection[x][1],collection[x][2],
        collection[x][0] + 1,collection[x][1] + 1,collection[x][2] + 1)
